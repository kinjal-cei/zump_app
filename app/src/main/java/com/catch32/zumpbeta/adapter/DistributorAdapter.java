 ...
 * @version Jun 19, 2019
 */
public class DistributorAdapter extends ArrayAdapter<DistReportData> {

    private Context mContext;
    private List<DistReportData> mList;

    public DistributorAdapter(Context context,
                              List<DistReportData> values) {
    ...
    @Override
    public DistReportData getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        mViewHolder.mName.setText(mList.get(position).getDist_nm());
