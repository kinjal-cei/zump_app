 ...
 * @version Jul 11, 2019
 */
public class DepartmentListAdapter extends ArrayAdapter<DepartmentList> {

    private Context mContext;
    private List<DepartmentList> mList;

    public DepartmentListAdapter(Context context,
                          List<DepartmentList> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        mViewHolder.mName.setText(mList.get(position).getName());
