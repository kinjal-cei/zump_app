...
public class Privacy_Policy extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        try {
            ...
            BookMyNewOrder.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View view)
                {
                    Intent intent=new Intent(Privacy_Policy.this, Book_My_New_Order_Activity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        {
            Intent i=new Intent(Privacy_Policy.this, Dashboard_Activity.class);
            startActivity(i);
        }
        else if (vid == R.id.nav_book_my_order)
        {
            Intent i = new Intent(Privacy_Policy.this, Book_My_New_Order_Activity.class);
            startActivity(i);
        }
        else if (vid == R.id.nav_order_status)
        {
            Intent i = new Intent(Privacy_Policy.this, Order_Status.class);
            startActivity(i);
        }
        else if (vid == R.id.nav_my_order)
        {
            Intent i = new Intent(Privacy_Policy.this, My_Order_Activity.class);
            startActivity(i);
        }
        else if (vid == R.id.nav_my_shop)
        {
            Intent i = new Intent(Privacy_Policy.this, MyShop.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_add_more_brands)
        {
            Intent i = new Intent(Privacy_Policy.this, Add_More_Brands.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_my_reward)
        {
            Intent i = new Intent(Privacy_Policy.this, My_Rewards.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_my_summary)
        {
            Intent i = new Intent(Privacy_Policy.this, Month_Wise_Summary.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_my_draft)
        {
            Intent i = new Intent(Privacy_Policy.this, Draft_Orders.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_feedback)
        {
            Intent i=new Intent(Privacy_Policy.this, Feedback_Activity.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_profile)
        {
            Intent i=new Intent(Privacy_Policy.this, Profile_Activity.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_Notification)
        {
           Intent i=new Intent(Privacy_Policy.this, Notification.class);
           startActivity(i);
        }
        ...
        {
            Intent i=new Intent(Privacy_Policy.this, TermsAndCondition.class);
            startActivity(i);
        }
        else if(vid == R.id.about_us)
        {
            Intent i=new Intent(Privacy_Policy.this, About_Us.class);
            startActivity(i);
        }
        else if(vid == R.id.call_us)
        {
            Intent i=new Intent(Privacy_Policy.this, Contact_Us.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_logout)
        {
            ...
            builder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener()
            {
                ...
                {
                    AppUserManager.logout(Privacy_Policy.this, SignInActivity.class);
                }
            });
