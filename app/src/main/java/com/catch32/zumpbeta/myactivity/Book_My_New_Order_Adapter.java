 ...
 * @version Jul 19, 2019
 */
public class Book_My_New_Order_Adapter extends ArrayAdapter<SubCategoryProdList>
{

    private Book_My_New_Order_Activity mActivity;
    private List<SubCategoryProdList> mList;

    public Book_My_New_Order_Adapter(Book_My_New_Order_Activity context, List<SubCategoryProdList> values)
    {
