...
public class VendorReport extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        BookMyNewOrder.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent=new Intent(VendorReport.this, Book_My_New_Order_Activity.class);
        ...
        btnMyShop.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Intent i = new Intent(VendorReport.this, MyShop.class);
                startActivity(i);
            }
        });
     ...
     Button btnBrandReport = findViewById(R.id.btnBrandReport);
        btnBrandReport.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Intent i = new Intent(VendorReport.this, BrandReport.class);
                startActivity(i);
            }
        });
        ...
        btnProductTypeReport.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Intent i = new Intent(VendorReport.this, ProductTypeReport.class);
                startActivity(i);
            }
        });
        ...
        btnOrderedProduct.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Intent i = new Intent(VendorReport.this, OrderedProductReport.class);
                startActivity(i);
            }
        });
        ...
        llOrderStatus.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(VendorReport.this, My_Order_Activity.class);
                startActivity(i);
            }
        });
        ...
        llHome.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Intent i = new Intent(VendorReport.this, Dashboard_Activity.class);
                startActivity(i);
            }
        });
        ...
        llMonthwiseSummary.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Intent i = new Intent(VendorReport.this, Month_Wise_Summary.class);
                startActivity(i);
            }
        });
        ...
        try {
            ...
            AndroidNetworking.initialize(VendorReport.this);
            ...
            Loading = ProgressDialog.show(VendorReport.this, "Loading Details", "Please Wait...", true, true);
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(VendorReport.this, Book_My_New_Order_Activity.class);
            startActivity(i);
        }
        else if (vid == R.id.nav_order_status)
        {
            Intent i = new Intent(VendorReport.this, Order_Status.class);
            startActivity(i);
        }
        ...
        {
            Intent i = new Intent(VendorReport.this, Add_More_Brands.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_my_reward)
        {
            Intent i = new Intent(VendorReport.this, My_Rewards.class);
            startActivity(i);
        }
        ...
        {
            Intent i = new Intent(VendorReport.this, Draft_Orders.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_feedback)
        {
            Intent i=new Intent(VendorReport.this, Feedback_Activity.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_profile)
        {
            Intent i=new Intent(VendorReport.this, Profile_Activity.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_Notification)
        {
            Intent i=new Intent(VendorReport.this, Notification.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_policy)
        {
            Intent i=new Intent(VendorReport.this, Privacy_Policy.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_terms_conditions)
        {
            Intent i=new Intent(VendorReport.this, TermsAndCondition.class);
            startActivity(i);
        }
        else if(vid == R.id.about_us)
        {
            Intent i=new Intent(VendorReport.this, About_Us.class);
            startActivity(i);
        }
        else if(vid == R.id.call_us)
        {
            Intent i=new Intent(VendorReport.this, Contact_Us.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_logout)
        {
            ...
            builder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener()
            {
                ...
                {
                    AppUserManager.logout(VendorReport.this, SignInActivity.class);
                }
            });
                ...
                public void run()
                {
                    ...
                    try {
                        ...
                        if (loginSuccess.equals("Y"))
                        {
                            ...
                            spinnerVendor.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
                            {
                                ...
                                public void onItemSelected(AdapterView<?> parent, View view, int position, long id)
                                {
                                    ...
                                    final TextView lblFilter1 = findViewById(R.id.lblFilter1);
                                    lblFilter1.setText("Vendor: "+selectedVendorStr+"; Product Type: "+selectedSubCategoryStr+"; Company: "+selectedCompanyStr);
                        ...
                        else
                        {
                            ...
                            Toast.makeText(VendorReport.this, errorString, Toast.LENGTH_LONG).show();
                        }
            ...
            handler.post(new Runnable()
            {
                ...
                public void run()
                {
                    ...
                    try {
                        ...
                        if (loginSuccess.equals("Y"))
                        {
                            Toast.makeText(VendorReport.this,"Quick Order saved in Draft Successfully.",Toast.LENGTH_LONG).show();
                        }
                        else
                        {
                            String errorString = responseJSON.getString("obj");
