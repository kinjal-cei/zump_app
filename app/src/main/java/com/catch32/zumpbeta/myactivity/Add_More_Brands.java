...
public class Add_More_Brands extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        try {
            ...
            setContentView(R.layout.activity_add_more_brands);
            ...
            BookMyNewOrder.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View view)
                {
                    Intent intent=new Intent(Add_More_Brands.this, Book_My_New_Order_Activity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        {
            Intent i=new Intent(Add_More_Brands.this, Dashboard_Activity.class);
            startActivity(i);
        }
        ...
        {
            Intent i = new Intent(Add_More_Brands.this, Order_Status.class);
            startActivity(i);
        }
        else if (vid == R.id.nav_my_order)
        {
            Intent i = new Intent(Add_More_Brands.this, My_Order_Activity.class);
            startActivity(i);
        }
        else if (vid == R.id.nav_my_shop)
        {
            Intent i = new Intent(Add_More_Brands.this, MyShop.class);
            startActivity(i);
        }

        else if(vid == R.id.nav_add_more_brands)
        {
           // Intent i = new Intent(Add_More_Brands.this, Add_More_Brands.class);
          //  startActivity(i);
        }
        else if(vid == R.id.nav_my_reward)
        {
            Intent i = new Intent(Add_More_Brands.this, My_Rewards.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_my_summary)
        {
            Intent i = new Intent(Add_More_Brands.this, Month_Wise_Summary.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_my_draft)
        {
            Intent i = new Intent(Add_More_Brands.this, Draft_Orders.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_feedback)
        {
            Intent i=new Intent(Add_More_Brands.this, Feedback_Activity.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_profile)
        {
            Intent i=new Intent(Add_More_Brands.this, Profile_Activity.class);
            startActivity(i);
        }
         else if(vid == R.id.nav_Notification)
        {
            Intent i=new Intent(Add_More_Brands.this, Notification.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_policy)
        {
            Intent i=new Intent(Add_More_Brands.this, Privacy_Policy.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_terms_conditions)
        {
            Intent i=new Intent(Add_More_Brands.this, TermsAndCondition.class);
            startActivity(i);
        }
        else if(vid == R.id.about_us)
        {
               Intent i=new Intent(Add_More_Brands.this, About_Us.class);
               startActivity(i);
        }
        else if(vid == R.id.call_us)
        {
            Intent i=new Intent(Add_More_Brands.this, Contact_Us.class);
            startActivity(i);
        }
        ...
        else if(vid == R.id.nav_logout)
        {
            ...
            builder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener()
            {
                ...
                {
                    AppUserManager.logout(Add_More_Brands.this, SignInActivity.class);
                }
            });
