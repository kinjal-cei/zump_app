...
public class ProductTypeReport extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    ArrayList<Company> productTypes = new ArrayList<Company>();
    ArrayList<Company> companies = new ArrayList<Company>();
    ArrayList<Company> subbrands = new ArrayList<Company>();

    String selectedProductType = "0", selectedCompany = "0", selectedSubBrand = "0";
    String selectedProductTypeStr = "", selectedCompanyStr = "", selectedSubBrandStr = "";
    int initialScrollYTab1 = 0;

    boolean loadData = true;

    String previousProductType= "", previousCompany = "", previousSubBrand = "";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_product_type_report);
        mContext = this;
        ...
        BookMyNewOrder.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent=new Intent(ProductTypeReport.this, Book_My_New_Order_Activity.class);
        ...
        btnMyShop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(ProductTypeReport.this, MyShop.class);
                startActivity(i);
            }
        });
        ...
        btnVendorReport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(ProductTypeReport.this, VendorReport.class);
                startActivity(i);
            }
        });
        ...
        btnBrandReport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(ProductTypeReport.this, BrandReport.class);
                startActivity(i);
            }
        });
        ...
        btnOrderedProduct.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(ProductTypeReport.this, OrderedProductReport.class);
                startActivity(i);
            }
        });
        ...
        llOrderStatus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(ProductTypeReport.this, My_Order_Activity.class);
                startActivity(i);
            }
        });
        ...
        llHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(ProductTypeReport.this, Dashboard_Activity.class);
                startActivity(i);
            }
        });
        ...
        llMonthwiseSummary.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(ProductTypeReport.this, Month_Wise_Summary.class);
                startActivity(i);
            }
        });
        ...
        try {
            ...
            final Spinner spinnerVendor = findViewById(R.id.spinnerProductType);
            final Spinner spinnerStatus = findViewById(R.id.spinnerCompany);
            final Spinner spinnerCompany = findViewById(R.id.spinnerSubBrand);
            final TextView lblFilter1 = findViewById(R.id.lblFilter1);
            final TextView lblVendor = findViewById(R.id.lblProductType);
            final TextView lblStatus = findViewById(R.id.lblCompany);
            ...
            AndroidNetworking.initialize(ProductTypeReport.this);

            JSONObject Param = new JSONObject();
            try {
                Param.accumulate("usercd", userCd);
                Param.accumulate("menuId", "4");
            ...
            ApiService apiService1 = new ApiService(getProductTypeMenuData, RequestType.GET,
                    TEST_MENU_DATA + Param.toString(),new HashMap<String, String>(), Param);

            Loading = ProgressDialog.show(ProductTypeReport.this, "Loading Details", "Please Wait...", true, true);
        }
        catch (Exception e)
        {
            e.printStackTrace();
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(ProductTypeReport.this, Book_My_New_Order_Activity.class);
            startActivity(i);
        }
        else if (vid == R.id.nav_order_status)
        {
            Intent i = new Intent(ProductTypeReport.this, Order_Status.class);
            startActivity(i);
        }
        ...
        {
            Intent i = new Intent(ProductTypeReport.this, Add_More_Brands.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_my_reward)
        {
            Intent i = new Intent(ProductTypeReport.this, My_Rewards.class);
            startActivity(i);
        }
        ...
        {
            Intent i = new Intent(ProductTypeReport.this, Draft_Orders.class);
            startActivity(i);
        }

        else if(vid == R.id.nav_feedback)
        {
            Intent i=new Intent(ProductTypeReport.this, Feedback_Activity.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_profile)
        {
            Intent i=new Intent(ProductTypeReport.this, Profile_Activity.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_Notification)
        {
            Intent i=new Intent(ProductTypeReport.this, Notification.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_policy)
        {
             Intent i=new Intent(ProductTypeReport.this, Privacy_Policy.class);
              startActivity(i);
        }
        else if(vid == R.id.nav_terms_conditions)
        {
            Intent i=new Intent(ProductTypeReport.this, TermsAndCondition.class);
            startActivity(i);
        }
        else if(vid == R.id.about_us)
        {
            Intent i=new Intent(ProductTypeReport.this, About_Us.class);
            startActivity(i);
        }
        else if(vid == R.id.call_us)
        {
            Intent i=new Intent(ProductTypeReport.this, Contact_Us.class);
            startActivity(i);
        }
        else if(vid == R.id.nav_logout)
        {
            ...
            builder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener()
            {
                ...
                {
                    AppUserManager.logout(ProductTypeReport.this, SignInActivity.class);
                }
            });
    ...
    OnResponseListener getProductTypeMenuData = new OnResponseListener()
    {
        @Override
                ...
                public void run()
                {
                    ...
                    try {
                        ...
                        if (loginSuccess.equals("Y"))
                        {
                            ...
                            final List<String> spinnerCompanyArray = new ArrayList<>();
                            ...
                            for (int j = 0; j < len; j++)
                            {
                                ...
                                spinnerCompanyArray.add(sub_cat_nm);
                            ...
                            ArrayAdapter<String> adapterSubcategory = new ArrayAdapter<String>(
                                    ProductTypeReport.this,
                                    android.R.layout.simple_spinner_item,
                                    spinnerCompanyArray
                            );

                            final Spinner SpinnerCompany = findViewById(R.id.spinnerCompany);
                            SpinnerCompany.setAdapter(adapterSubcategory);
                            SpinnerCompany.setSelection(Integer.parseInt(spinnerId));
                            ...
                            List<String> spinnerProductTypeArray = new ArrayList<>();
                            ...
                            for (int j = 0; j < len; j++)
                            {
                                ...
                                spinnerProductTypeArray.add(cat_nm);

                                Company companyObj = new Company();
                                companyObj.comp_id = cat_id;
                                companyObj.comp_nm = cat_nm;

                                productTypes.add(companyObj);

                            }
                            previousProductType = productTypes.get(0).comp_id;
                            selectedProductType = productTypes.get(0).comp_id;
                            ...
                            spinnerProductType.setAdapter(adapterVendor);
                            //spinnerCompany.setSelection(Integer.parseInt(compId));
                            ...
                            spinnerProductType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
                            {
                                ...
                                public void onItemSelected(AdapterView<?> parent, View view, int position, long id)
                                {
                                    ...
                                    selectedProductType = productTypes.get(position).comp_id;
                                    selectedProductTypeStr = productTypes.get(position).comp_nm;

                                    RelativeLayout rlProductSummaries = findViewById(R.id.rlProductSummaries);

                                    if(selectedProductType.equals("0") && selectedCompany.equals("0") && selectedSubBrand.equals("0")){
                                    ...
                                    else if(!previousProductType.equals(selectedProductType) || !previousCompany.equals(selectedCompany) || !previousSubBrand.equals(selectedSubBrand)){
                                        ...
                                        try {
                                            ...
                                            Param.accumulate("usercd",userCd);
                                            Param.accumulate("menuId","4");
                                            Param.accumulate("selectedDropId",selectedProductType);
                                            Param.accumulate("selectedStatus",selectedCompany);
                                    ...
                                    final TextView lblFilter1 = findViewById(R.id.lblFilter1);
                                    lblFilter1.setText("Product Type: "+selectedProductTypeStr+"; Company: "+selectedCompanyStr+"; Sub Brand:"+selectedSubBrandStr);
                            ...
                            spinnerSubBrand.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
                            {
                                ...
                                public void onItemSelected(AdapterView<?> parent, View view, int position, long id)
                                {
                                    ...
                                    if(selectedProductType.equals("0") && selectedSubBrand.equals("0") && selectedCompany.equals("0")){
                                    ...
                                    else if(!previousProductType.equals(selectedProductType) || !previousSubBrand.equals(selectedSubBrand) || !previousCompany.equals(selectedCompany)){
                        ...
                        else
                        {
                            ...
                            Toast.makeText(ProductTypeReport.this, errorString, Toast.LENGTH_LONG).show();
                        }
                    ...
                    try
                    {
                        ...
                        if (loginSuccess.equals("Y"))
                        {
                            try {
                                ...
                                String totalVendors = CM_ROOM_NO_1.split(" Total Brand\\(s\\): ")[0].split(": ")[1].trim();
                                String totalBrands = CM_ROOM_NO_1.split(" Total Brand\\(s\\): ")[1].trim();
                                ...
                                if(Integer.parseInt(totalVendors) == 1){
                                    ...
                                    for (int j = 1; j < len; j++) {
                                        ...
                                        if(!SHARE.contains("out of")) {
                                            ...
                                            vendorSummaryTitle.setText("Data of "+CM_ROOM_FY_1);
                                ...
                                for (int j = 0; j < len; j++)
                                {
                                    ...
                                    ProductTypeReport.Company companyObj = new ProductTypeReport.Company();
                                    companyObj.comp_id = sub_cat_id;
                                    companyObj.comp_nm = sub_cat_nm;

                                    companies.add(companyObj);

                                    if(selectedCompany.equals(sub_cat_id)) {
                                        subcategoryIndex = j;
                                    }
                                }
                                ...
                                final Spinner SpinnerSubcategory = findViewById(R.id.spinnerCompany);
            ...
            handler.post(new Runnable()
            {
                ...
                public void run()
                {
                    ...
                    try {
                        ...
                        if (loginSuccess.equals("Y"))
                        {
                            Toast.makeText(ProductTypeReport.this,"Quick Order saved in Draft Successfully.",Toast.LENGTH_LONG).show();
                        }
                        else
                        {
                            String errorString = responseJSON.getString("obj");
